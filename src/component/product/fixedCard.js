...
// Same as Card By the difference is fixed width
//
//

export default function FixedCard({ img, title, price, imgs, url, discount }) {
  //State
  ...
  return (
    <div className="w-[352.3px] relative  text-start">
      {/* Main Image */}
      ...
      <div className="my-3">
        <Link href="/" className=" hover:text-red font-semibold ">
          <h3>{title}</h3>
        </Link>
